...
| **Total** | — | | **✓ Complete:** Plans 0, 2A, 1a-protocol/host/engine, RTQ, 1a-host-bugs, 1b, 1b.1, 1c, 1c.2, 1c3, 1a.6, 2, 3, 4, 4a, 4b, 4c, 4c.2, 6. **○ Not started / ◔ stub:** Plans 4d (0/39), 5 (research stub), 7 (0/13), 7a (2/23 research), 9 (0/46), 10 (0/53). **⛔ Tombstoned:** Plan 8 (diagrams-are-not-engines; see row). |

> **Status key:** ✓ complete · ◐ in progress · ○ not started (design may be ratified) · ◔ research stub · ⛔ tombstoned (obsoleted, will not be implemented). Checklist tallies (x/total) re-audited 2026-07-24 against each plan's own checkboxes.
