...
| [**Plan 4b: Shadow-engine feature validation**](2026-07-01-plan4b-shadow-engine-features.md) | 2-3 | Plan 4 | ◐ **In progress** (3/52; only prerequisite checks ticked). Validates tier model + inert surfaces a single-Primary Julia can't reach; implements the `_quarto.yml engines:` splice (Task 9). Excludes Plan 5/6/7/Phase 12/1.6 work. |
