...
**Date:** 2026-05-26 (revised 2026-05-29; 2026-06-03; 2026-06-03 source-verification pass — reference fixes #1–4, three-way leaf/container classifier, R4 fallback rule, `LineAware` filter-nesting semantics, R3/R4 table-exclusivity + Property #9 range-equality invariants stated, plus baseline/calibration/CustomNode-inventory/stale-comment checklist items)
...
- `is_container_block(n)` (`compute.rs:218` — Div, BlockQuote, Ordered/Bullet/DefinitionList, Figure, Table, Custom) → **block container**, R3 (recurse block children).
