...
///
/// This is the unified conversion function that replaces both:
/// - `yaml_to_meta_with_source_info` (for document metadata)
/// - `config_value_from_yaml` (for project config, when called with ProjectConfig context)
///
...
/// 2. Returns ConfigValue instead of MetaValueWithSourceInfo
/// 3. Uses InterpretationContext::DocumentMetadata (parse strings as markdown by default)
///
/// This function is intended to replace `rawblock_to_meta_with_source_info` as part
/// of the type unification effort (k-2tu9).
///
/// # Panics
///
