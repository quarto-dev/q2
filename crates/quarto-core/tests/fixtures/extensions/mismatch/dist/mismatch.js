...
// crates/quarto-core/tests/fixtures/extensions/mismatch/src/mismatch.ts
var _quarto;
var mismatchEngine = {
  name: "mismatch",
  defaultExt: ".mismatch",
  ...
  launch(_context) {
    return {
      ...
      async execute(opts) {
        ...
        const executed = input.replace(/```\{synth\}[\s\S]*?```/g, "::: {.cell}\n::: {.cell-output .cell-output-stdout}\n**MISMATCH_EXECUTED**\n:::\n:::");
        return {
          markdown: executed,
          supporting: [],
          filters: []
...
var mismatch_default = mismatchEngine;
export {
  mismatch_default as default
};
