...
// crates/quarto-core/tests/fixtures/extensions/fallback-univ/src/fallback-univ.ts
var _quarto;
var fallbackUnivEngine = {
  name: "fallback-univ",
  ...
  launch(_context) {
    return {
      ...
      async execute(opts) {
        ...
        const executed = input.replace(/```\{([a-zA-Z0-9_.]+)\}[\s\S]*?```/g, (_match, lang) => `::: {.cell}
...
var fallback_univ_default = fallbackUnivEngine;
export {
  fallback_univ_default as default
};
