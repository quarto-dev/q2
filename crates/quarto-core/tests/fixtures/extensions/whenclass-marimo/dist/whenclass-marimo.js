...
// crates/quarto-core/tests/fixtures/extensions/whenclass-marimo/src/whenclass-marimo.ts
var _quarto;
var whenclassMarimoEngine = {
  ...
  launch(_context) {
    return {
      ...
      async execute(opts) {
        ...
        const executed = input.replace(/```\{pysynth\s+\.marimo\}[\s\S]*?```/g, "::: {.cell}\n::: {.cell-output .cell-output-stdout}\n**WHENCLASS_MARIMO_EXECUTED**\n:::\n:::");
        return {
          markdown: executed,
          supporting: [],
          filters: []
...
var whenclass_marimo_default = whenclassMarimoEngine;
export {
  whenclass_marimo_default as default
};
