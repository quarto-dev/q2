/**
 * beta — synthetic Primary-claims engine fixture (Plan 4b Task A1).
 *
 * Claims the "synth" language as Primary(priority 1), identically to `alpha`
 * (see `../alpha/src/alpha.ts`). The (alpha, beta) pair is the
...
const betaEngine: ExecutionEngineDiscovery = {
  name: "beta",
  defaultExt: ".beta",
