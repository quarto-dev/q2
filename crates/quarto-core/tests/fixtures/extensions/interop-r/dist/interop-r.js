...
// crates/quarto-core/tests/fixtures/extensions/interop-r/src/interop-r.ts
var _quarto;
var interopREngine = {
  name: "interop-r",
  defaultExt: ".interopr",
  ...
  launch(_context) {
    return {
      ...
      async execute(opts) {
        ...
        executed = executed.replace(/```\{rsynth\}[\s\S]*?```/g, "::: {.cell}\n::: {.cell-output .cell-output-stdout}\n**INTEROP_R_RSYNTH_EXECUTED**\n:::\n:::");
        executed = executed.replace(/```\{pysynth\}[\s\S]*?```/g, "::: {.cell}\n::: {.cell-output .cell-output-stdout}\n**INTEROP_R_PYSYNTH_EXECUTED**\n:::\n:::");
        return {
          markdown: executed,
          supporting: [],
          filters: []
...
var interop_r_default = interopREngine;
export {
  interop_r_default as default
};
