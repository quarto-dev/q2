...
- [`6aff8103`](https://github.com/quarto-dev/q2/commits/6aff8103): Small and narrow windows now degrade gracefully: dialogs cap their height and scroll internally instead of clipping their buttons, menus never exceed the window width, the projects-home header and editor header wrap onto two rows, and project names in the list keep a readable minimum width instead of being squeezed away.
