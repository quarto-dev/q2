...
- Plan-2pre carve-up of the q2-debug renderer (Phase 1 + Phase 2). The renderer is now split into `framework/` (format-agnostic recursive dispatch + types + the typed registry contract) and `q2-debug/` (bordered-box leaves + dispatchers + format registry + iframe wrapper + entry point). The iframe route renames from `/ast-renderer.html` to `/q2-debug.html`; the iframe component renames from `AstIframe` to `Q2DebugIframe`; the format registry renames from `componentRegistry` to `q2DebugRegistry`. The `__REACT_AST_DEBUG_RENDERER__` window global is preserved for user-TSX consumers. Dispatcher fallbacks dropped; `<Ast>`'s `registry` prop is now required. Figure body-only collapse: the literal `// TODO:` text from the bordered Figure DOM is gone (Bug A); the bordered "Caption: ShortCaption" line is preserved as a port to q2-debug's `Figure` component. `MathInline` added to `InlineNode`. Behavior preservation verified end-to-end. Per-step commits: [`f3a27c81`](https://github.com/quarto-dev/q2/commits/f3a27c81), [`d73bc93a`](https://github.com/quarto-dev/q2/commits/d73bc93a), [`4a41e00d`](https://github.com/quarto-dev/q2/commits/4a41e00d), [`e7347ae9`](https://github.com/quarto-dev/q2/commits/e7347ae9), [`408ea3c5`](https://github.com/quarto-dev/q2/commits/408ea3c5), [`3c05e05c`](https://github.com/quarto-dev/q2/commits/3c05e05c), [`5c107829`](https://github.com/quarto-dev/q2/commits/5c107829), [`eff73986`](https://github.com/quarto-dev/q2/commits/eff73986), [`fc47894f`](https://github.com/quarto-dev/q2/commits/fc47894f), [`6bf4a7e4`](https://github.com/quarto-dev/q2/commits/6bf4a7e4), [`a3b00ce4`](https://github.com/quarto-dev/q2/commits/a3b00ce4), [`f8d7b86c`](https://github.com/quarto-dev/q2/commits/f8d7b86c). Phase-1 commit (the structural split landing behind a re-export shim): [`a4a2b3c5`](https://github.com/quarto-dev/q2/commits/a4a2b3c5).
