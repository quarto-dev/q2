      ...
      <div className="preview-status-actions">
        {confirming ? (
          <>
            <button
              type="button"
              className="qh-btn small preview-status-clear-confirm-btn"
            ...
            <button
              type="button"
              className="qh-btn small preview-status-cancel-btn"
          ...
          <>
            {canClear && (
              <button
                type="button"
                className="qh-btn small preview-status-clear-btn"
            ...
            {canRun && (
              <button
                type="button"
                className="qh-btn small preview-status-run-btn"
                onClick={handleRun}
                disabled={busy}
