...
// the DB runs schema migrations that console.log asynchronously, and these
// tests finish fast enough that the logs can outlive the file, failing the
// run with "Closing rpc while onUserConsoleLog was pending".
